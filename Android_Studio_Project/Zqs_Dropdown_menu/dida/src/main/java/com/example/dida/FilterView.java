...
public class FilterView extends LinearLayout implements View.OnClickListener, FilterAdapter.ItemClickCallBack {
    ...
    private Map<View, List<String>> source = new HashMap<>();
        ...
        for (Map.Entry<Integer, List<String>> entry : map.entrySet()) {
            ...
            switch (num) {
                case TYPE:
                    ...
                    source.put(tvStrokeType, typeList);
                    break;
                case STATUS:
                    statusList = entry.getValue();
                    source.put(tvStrokeStatus, statusList);
                    break;
            }
        }
        initPopView();
    ...
    private void initPopView() {
        ...
        for (Map.Entry<View, List<String>> item : source.entrySet()) {
            ...
            FilterAdapter adapter = new FilterAdapter((List<String>) item.getValue(), mContext);
